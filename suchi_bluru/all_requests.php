 ...
 <body>
 				...
 				<div class="col-md-12">
 					<div class="navbar-collapse collapse ">
 						<ul id="menu-top" class="nav navbar-nav navbar-left">
 							...
 							<li><a href="all_requests.php" class="menu-top-active">WASTE PICKUP REQUESTS</a></li>
 	...
 	<div class="content-wrapper">
 		<div class="container">
 			<div class="row pad-botm">
 				<div class="col-md-12">
 					<h4 class="header-line">Admin <?php echo $_SESSION['login_user']['Pin_Code']; ?> : Request History</h4>
 				</div>
 			</div>
 			<div class="row">
 				<div class="col-md-12">
 							...
 							<div class="table-responsive">
 								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
 									...
 									<tbody>
 										...
 										on `waste_pickup_request`.`Request_ID` = `waste`.`Request_ID` and `waste_pickup_request`.`Pin_code`='$pincode' ORDER BY `waste_pickup_request`.`Pickup_Date` DESC";
 	...
 	<!-- CUSTOM SCRIPTS  -->
 	<script src="assets/js/custom.js"></script> <!--required for search bar-->
 </body>
</html>
